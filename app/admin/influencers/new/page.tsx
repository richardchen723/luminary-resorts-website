...
export default function NewInfluencerPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      alert(error.message || "Failed to create influencer")
      setLoading(false)
    }
  }
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Create a new influencer profile and generate a referral link
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Fill in the details below. A unique referral code will be generated automatically.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <Button type="button" variant="outline" asChild>
                <Link href="/admin/influencers">Cancel</Link>
              </Button>
            </div>
          </form>
        </CardContent>
