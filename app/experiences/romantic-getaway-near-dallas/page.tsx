...
export const metadata: Metadata = generateSEOMetadata({
  title: 'Romantic Getaway Near Dallas | Luxury Cabins 3 Hours Away | Luminary Resorts',
  description: 'Ultimate romantic getaway 3 hours from Dallas. Private pools, floor-to-ceiling windows, complete seclusion. Perfect for anniversaries, proposals, and reconnection. Book now.',
  path: '/experiences/romantic-getaway-near-dallas',
})

export default async function RomanticGetawayDallasPage() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'How far is Luminary Resorts from Dallas?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Luminary Resorts is located just 3 hours from Dallas, making it the perfect romantic getaway destination for couples seeking an escape from the city.',
        },
      },
      {
        '@type': 'Question',
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[70vh] flex items-center justify-center mt-20 overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto text-white">
          <h1 className="font-serif text-5xl md:text-6xl mb-6">Romantic Getaway for Couples Near Dallas</h1>
          <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">
            Escape the city and reconnect in complete privacy. Just 3 hours from Dallas, our luxury cabins offer the perfect setting for romance, intimacy, and deep connection.
          </p>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-lg leading-relaxed text-muted-foreground mb-6">
              Luminary Resorts at Hilltop offers exactly that. Located just 3 hours from Dallas, our luxury tiny house retreat provides couples with the perfect romantic getaway—a sanctuary where you can escape the noise, reconnect with each other, and remember what it feels like to simply be together.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <Card>
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Just 3 hours from Dallas, you can escape the city for a weekend getaway. Perfect for planned romantic retreats and special occasions.
                  </p>
                </CardContent>
              </Card>
              <Card>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              Luminary Resorts is located in Coldspring, Texas, just 3 hours from Dallas. Our hilltop setting offers rare elevated views and complete privacy, making it the perfect romantic escape.
            </p>
      ...
      <section className="py-24 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6">
            <Card>
              <CardContent className="p-6">
                <h3 className="font-serif text-xl mb-3">How far is Luminary Resorts from Dallas?</h3>
                <p className="text-muted-foreground">
                  Luminary Resorts is located just 3 hours from Dallas, making it the perfect romantic getaway destination for couples seeking an escape from the city.
                </p>
              </CardContent>
            </Card>
            <Card>
      ...
      <section className="py-24 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Escape the city and reconnect with your partner. Just 3 hours from Dallas, your perfect romantic retreat awaits.
          </p>
