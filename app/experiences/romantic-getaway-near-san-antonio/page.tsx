...
export const metadata: Metadata = generateSEOMetadata({
  title: 'Romantic Getaway Near San Antonio | Luxury Cabins 4 Hours Away | Luminary Resorts',
  description: 'Ultimate romantic getaway 4 hours from San Antonio. Private pools, floor-to-ceiling windows, complete seclusion. Perfect for anniversaries, proposals, and reconnection. Book now.',
  path: '/experiences/romantic-getaway-near-san-antonio',
})

export default async function RomanticGetawaySanAntonioPage() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'How far is Luminary Resorts from San Antonio?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Luminary Resorts is located just 4 hours from San Antonio, making it the perfect romantic getaway destination for couples seeking an escape from the city.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Our four intimate cabins offer complete privacy, luxury amenities including private pools in each cabin, floor-to-ceiling windows with stunning hilltop views, and a secluded setting designed for couples to reconnect and deepen their bond. Unlike traditional vacation rentals, each cabin features Asian Zen-inspired design, romantic interiors, and complete seclusion.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'All our cabins are perfect for romantic getaways. Each features a private pool, sweeping hilltop views, romantic interiors, and complete privacy. Select cabins feature skylights for stargazing, and all offer unique interior design styles from Asian Zen to contemporary. Each cabin is designed for intimacy and connection, unlike traditional vacation rentals.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Each cabin includes a private pool, luxury bedding, premium bath products, coffee station, climate control, Wi-Fi, and complete privacy. Select cabins feature skylights for stargazing, and all have standalone bathtubs and sweeping hilltop views perfect for romantic moments.',
        },
      },
      {
        '@type': 'Question',
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[70vh] flex items-center justify-center mt-20 overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto text-white">
          <h1 className="font-serif text-5xl md:text-6xl mb-6">Romantic Getaway for Couples Near San Antonio</h1>
          <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">
            Escape the city and reconnect in complete privacy. Just 4 hours from San Antonio, our luxury cabins offer the perfect setting for romance, intimacy, and deep connection.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="rounded-full">
              <Link href="/#booking">Check Availability</Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="rounded-full bg-white/10 backdrop-blur-sm border-white/50 hover:bg-white/20 text-white">
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-lg leading-relaxed text-muted-foreground mb-6">
              Luminary Resorts at Hilltop offers exactly that. Located just 4 hours from San Antonio, our luxury tiny house retreat provides couples with the perfect romantic getaway—a sanctuary where you can escape the noise, reconnect with each other, and remember what it feels like to simply be together.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <Card>
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Just 4 hours from San Antonio, you can escape the city for a weekend getaway. Perfect for planned romantic retreats and special occasions.
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Each cabin features a private pool, floor-to-ceiling windows with sweeping hilltop views, standalone bathtubs, and stargazing opportunities—every detail is designed to enhance your romantic experience and create moments you'll remember forever. Unlike traditional vacation rentals, you'll have complete privacy and luxury amenities.
                  </p>
                </CardContent>
              </Card>
              <Card>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              Luminary Resorts is located in Coldspring, Texas, just 4 hours from San Antonio. Our hilltop setting offers rare elevated views and complete privacy, making it the perfect romantic escape.
            </p>
      ...
      <section className="py-24 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6">
            <Card>
              <CardContent className="p-6">
                <h3 className="font-serif text-xl mb-3">How far is Luminary Resorts from San Antonio?</h3>
                <p className="text-muted-foreground">
                  Luminary Resorts is located just 4 hours from San Antonio, making it the perfect romantic getaway destination for couples seeking an escape from the city.
                </p>
              </CardContent>
            </Card>
            <Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  All our cabins are perfect for romantic getaways. Each features a private pool, sweeping hilltop views, romantic interiors, and complete privacy. Select cabins feature skylights for stargazing, and all offer unique interior design styles from Asian Zen to contemporary. Each cabin is designed for intimacy and connection, unlike traditional vacation rentals.
                </p>
              </CardContent>
            </Card>
            <Card>
      ...
      <section className="py-24 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Escape the city and reconnect with your partner. Just 4 hours from San Antonio, your perfect romantic retreat awaits.
          </p>
